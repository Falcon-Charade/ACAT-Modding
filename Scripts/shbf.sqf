...
===================================================================================================
 Script:        shbf.sqf
 Title:         Super Head Bug Fix
 Author:        Falcon Charade |  Contact: Falcon Charade on github
 Version:       1.0.0          |  Last updated: 2025-08-30

 Description:
   The Head Bug Fix in the pause menu sometimes doesn't work that well.
   This adds a function to the self interact for players. When activated, it kills
   the player and resets their state to how it was when they called the action.

 Usage:
   To execute the script:
     [] execVM "scripts\shbf.sqf";
...
_respawntime = getNumber (missionConfigFile >> "respawnDelay");
