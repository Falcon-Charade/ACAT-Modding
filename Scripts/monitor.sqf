...
/*
	Modified by Falcon Charade:
	Added safe params and state to call the script multiple times without issues.
	Allowed the delay to be set as a param.
	Allows the script to be started and stopped cleanly multiple times.
*/
